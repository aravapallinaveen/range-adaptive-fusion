...
from configs.fusion_config import MATCHING_DIST_THRESH, BASELINE_WEIGHTS, CONFIDENCE_THRESHOLDS
import numpy as np
...
def baseline_fusion(ouster_boxes, aeva_boxes, conti_boxes):
    final_fused_boxes = []
    ...
    for g in final_groups:
        fused_box = fuse_matched_boxes(g, BASELINE_WEIGHTS)
